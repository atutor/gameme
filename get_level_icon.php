...
$level = queryDB($sql, array(TABLE_PREFIX, $course_id, $level_id), TRUE);
// Check for course level icon first
$level_file = AT_CONTENT_DIR.$course_id.'/gameme/levels/'.$level['icon'];
